...
var Index={init:function(){new Vue({el:"#main",data:{updateTime:"",newsTitle:"",newsLink:"",newConfirmed:"",newDeath:"",dataCSV:[],dataMap:[],readMore:[],dictArrCSV:[],handleMap:[]},methods:{async fetchNews(){try{const e=(await $.get("https://spreadsheets.google.com/feeds/list/1az3e1HrKoe1kf2oa5AcKcTOd5UP3Sy-zRzc8RvfKJjA/1/public/values?alt=json")).feed.entry;this.newsTitle=e[0].gsx$title.$t,this.newsLink=e[0].gsx$link.$t,this.newConfirmed=e[0].gsx$newconfirmed.$t,this.newDeath=e[0].gsx$newdeath.$t}catch(e){console.error(e)}},async fetchRead(){try{const t=(await $.get("https://spreadsheets.google.com/feeds/list/1az3e1HrKoe1kf2oa5AcKcTOd5UP3Sy-zRzc8RvfKJjA/2/public/values?alt=json")).feed.entry,a=[];for(var e in t){let o={};o.category_id=t[e].gsx$categoryid.$t,o.category_name=t[e].gsx$categoryname.$t,o.title=t[e].gsx$title.$t,o.link=t[e].gsx$link.$t,o.thumbnail=t[e].gsx$thumbnail.$t,a.push(o)}this.readMore=a}catch(e){console.error(e)}},async fetchCSV(){try{const t=await $.get("https://spreadsheets.google.com/feeds/list/1az3e1HrKoe1kf2oa5AcKcTOd5UP3Sy-zRzc8RvfKJjA/3/public/values?alt=json"),a=t.feed.entry,o=[];for(var e in a){let t={};t.id=parseInt(a[e].gsx$id.$t),t.type=a[e].gsx$type.$t,t.name_zh=a[e].gsx$namezh.$t,t.confirmed=parseInt(a[e].gsx$confirmed.$t),t.death=parseInt(a[e].gsx$death.$t),t.note=a[e].gsx$note.$t,o.push(t)}this.dataCSV=o,this.updateTime=t.feed.updated.$t}catch(e){console.error(e)}finally{$(".loading span").text("載入中 [ 1/3 ]");const e=this.dataCSV;this.dictArrCSV=e.reduce((e,t,a)=>{let o=t.id;return delete t.id,e[o]=t,e},{})}},async fetchMap(){try{const e=await $.get("data/merged.simplify.json");this.dataMap=e.features}catch(e){console.error(e)}finally{TimeLine=(new TimelineMax).add(()=>{$(".loading span").text("載入中 [ 2/3 ]");const e=this.dataMap;this.handleMap=e.map(e=>{var t=e.properties,a=t.NE_ID;if(this.dictArrCSV.hasOwnProperty(a)){var o=this.dictArrCSV[a];Object.assign(t,o)}return e})},.5).add(()=>{$(".loading span").text("載入中 [ 3/3 ]"),this.initMap(),this.loadingDone()},1).add(()=>{window.scrollTo(0,0)})}},initIndex(){const e=$(window).height();controller=new ScrollMagic.Controller,introTL=(new TimelineMax).to(".intro",1,{alpha:0,ease:Power3.easeOut},0).set(".intro",{className:"+=active"},.5).set(".intro",{display:"none"}),scene=new ScrollMagic.Scene({triggerElement:".scene",triggerHook:"onLeave",duration:1*e}).setPin(".map").setTween(introTL).addTo(controller),scene=new ScrollMagic.Scene({triggerElement:".statistic",triggerHook:"onEnter",offset:100}).setClassToggle(".map .button","active").setTween(TweenLite.to(".map .button",.5,{alpha:0})).addTo(controller),TweenLite.from(".loading .container",1,{alpha:0,ease:Power3.easeOut})},initMap(){var e=L.map("leaflet").setView([33.798544,103.844217],4);e.scrollWheelZoom.disable(),e.doubleClickZoom.disable(),L.tileLayer("",{attribution:"",maxZoom:6,minZoom:2,noWrap:!0}).addTo(e);var t,a=L.control();function o(e){return e>2999?"#350000":e>999?"#600000":e>499?"#910000":e>199?"#d32f2f":e>99?"#f95050":e>29?"#ff7373":e>0?"#ffabab":"#9B9B9B"}function n(e){var t=$(".info.leaflet-control"),a=$(".leaflet-overlay-pane");e?(TweenLite.to(t,.2,{alpha:1,scale:1}),L.Browser.touch?a.bind("mousedown",e=>{TweenLite.set(t,{x:e.clientX-50,y:e.clientY-175})}):a.bind("mousemove",e=>{TweenLite.to(t,.2,{x:e.clientX,y:e.clientY})})):(a.unbind("mousemove"),TweenLite.to(t,.2,{alpha:0,scale:0}))}a.onAdd=function(e){return this._div=L.DomUtil.create("div","info"),this.update(),this._div},a.update=function(e){this._div.innerHTML=e?"<h6>"+e.name_zh+'</h6><div class="confirmed">確診 '+e.confirmed+' 例</div><div class="death">死亡 '+e.death+' 例</div><div class="note">'+e.note+"</div>":""},a.addTo(e),t=L.geoJson(this.handleMap,{style:e=>({weight:1,opacity:1,color:"#5b5b5b",fillOpacity:1,fillColor:o(e.properties.confirmed)}),onEachFeature:(e,o)=>{L.Browser.touch?o.on({mousedown:t=>{var o=t.target;o.setStyle({weight:2,color:"#000000"}),L.Browser.ie||L.Browser.opera||L.Browser.edge||o.bringToFront(),0!==e.properties.confirmed?(n(!0),a.update(e.properties)):n(!1)},mouseup:e=>{n(!1),t.resetStyle(e.target),a.update()}}):o.on({mouseover:t=>{var o=t.target;o.setStyle({weight:2,color:"#000000"}),L.Browser.ie||L.Browser.opera||L.Browser.edge||o.bringToFront(),0!==e.properties.confirmed?(n(!0),a.update(e.properties)):n(!1)},mouseout:e=>{n(!1),t.resetStyle(e.target),a.update()}})}}).addTo(e),n(!1)},mapButton(){TweenLite.to(window,1,{scrollTo:".statistic",autoKill:!1,ease:Power3.easeInOut})},loadingDone(){TimeLine=(new TimelineMax).to(".loading .container",1,{alpha:0,ease:Power3.easeIn}).to(".loading",1,{alpha:0,ease:Power3.easeIn},1).set(".loading",{display:"none"},2)}},computed:{groupByCategory(){return _.chain(this.readMore).groupBy("category_name").value()},groupByType(){return _.chain(this.dataCSV).filter(e=>0!==e.confirmed).orderBy("confirmed","desc").groupBy("type").value()}},filters:{sumData(e,t){let a=0;for(let o in e)"confirmed"===t?a+=e[o].confirmed:"death"===t&&(a+=e[o].death);return a},formateTime:e=>moment(String(e)).format("YYYY-MM-DD HH:mm:ss"),groupName:e=>"china"===e?"中國大陸境內":"world"===e?"中國大陸境外":""},created(){this.fetchNews(),this.fetchRead(),this.fetchCSV(),this.fetchMap()},mounted(){this.initIndex()}})}};