			...
			new Vue({
				...
				data: {
					...
					filterData: [
						{
							'date': '12.31',
							'text': '武漢衞健委首發疫情公告，稱未發現「明顯人傳人」；港府加強出入境口岸健康監察。' 
						},{
							'date': '1.20',
							'text': '鍾南山表示新冠病毒「人傳人」；台灣成立「中央流行疫情指揮中心」。' 
						},{
							'date': '1.21',
							...
							'date': '1.26',
							'text': '港府宣布翌日起限制湖北居民及過去14日到過湖北人士入境。WHO將疫情全球風險改為高風險。' 
						},{
							'date': '2.2',
							'text': '中國停發赴港澳旅遊簽註；美國禁止14日內到過中國大陸的非美國公民或居民入境。' 
						},{
							'date': '2.5',
							'text': '香港2.3出現首例死亡；港府宣布2.8起從中國大陸入境人士須強制檢疫14天；鑽石公主號確診10例，日本政府要求乘客留在船上最長14天。' 
						},{
							'date': '2.10',
							'text': '台灣宣布翌日起港澳地區人士除特例之外，皆暫緩入境。' 
						},{
							'date': '2.17',
							'text': '台灣2.15出現首例死亡暨社區感染案例；鑽石公主號新增確診99例，累計454例。' 
						},{
							'date': '2.19',
							'text': '俄羅斯宣布翌日起禁止中國公民入境；韓國在大邱市某教堂發現超級傳播事件，兩日增超百例確診。' 
						},{
							'date': '3.4',
							'text': '全球至少80個國家及地區出現確診個案。南韓確診超5600宗；伊朗累計確診增至逾2300宗。'
						},{
							'date': '3.7',
							'text': '全球確診病例破10萬，南韓確診累計7041例，為中國境外最多；意大利累計死亡197例，死亡率全球最高；多哥、哥倫比亞、馬耳他分別通報首宗確診。'
						},{
							'date': '3.9',
							'text': '義大利成為除中國外，第一個確診人數破萬的國家，當天宣布全國封城，限制公眾集會。'
						},{
							'date': '3.18',
							'text': '全球累計確診超過20萬，其中意大利確診逾3萬，伊朗超過1.7萬，美國、西班牙均突破1.3萬。'
						},{
							'date': '3.26',
							'text': '美國確診病例數突破8.2萬，超過中國和意大利。'
						},{
							'date': '4.3',
							'text': '全球累計確診破百萬。'
						},{
				...
				methods: {
					...
					async fetchCSV(){
						try {
							...
							for(var i in data) {
                                ...
                                item.confirmed_200309 = parseInt(data[i].gsx$confirmed200309.$t);
								item.death_200309 = parseInt(data[i].gsx$death200309.$t);
								...
								item.confirmed_200217 = parseInt(data[i].gsx$confirmed200217.$t);
								item.death_200217 = parseInt(data[i].gsx$death200217.$t);
								item.confirmed_200210 = parseInt(data[i].gsx$confirmed200210.$t);
								item.death_200210 = parseInt(data[i].gsx$death200210.$t);
								item.confirmed_200205 = parseInt(data[i].gsx$confirmed200205.$t);
								item.death_200205 = parseInt(data[i].gsx$death200205.$t);
								item.confirmed_200202 = parseInt(data[i].gsx$confirmed200202.$t);
								item.death_200202 = parseInt(data[i].gsx$death200202.$t);
								item.confirmed_200126 = parseInt(data[i].gsx$confirmed200126.$t);
								item.death_200126 = parseInt(data[i].gsx$death200126.$t);
					...
					initIndex(){
						...
						introTL = new TimelineMax()
							.to('.intro', 1, {alpha: 0, ease: Power3.easeOut}, 0)
							.set('.intro', {className: '+=active'}, .5)
							.set('.intro', {display: 'none'})
						scene = new ScrollMagic.Scene({ triggerElement: ".scene", triggerHook: 'onLeave', duration: winH*0.5})
							.setPin('.map')
							.setTween(introTL)
							.addTo(controller)
						...
						this.geojson.eachLayer(function (layer) {
							...
							switch(date){
								...
								case '3':
									...
									break;
								case '4':
									$confirmed = layer.feature.properties.confirmed_200126;
									$death = layer.feature.properties.death_200126;
									break;
								case '5':
									$confirmed = layer.feature.properties.confirmed_200202;
									$death = layer.feature.properties.death_200202;
									break;
								case '6':
									...
									break;
								case '7':
									$confirmed = layer.feature.properties.confirmed_200210;
									$death = layer.feature.properties.death_200210;
									break;
								case '8':
								...
								case '11':
									...
									break;
								case '12':
									$confirmed = layer.feature.properties.confirmed_200309;
									$death = layer.feature.properties.death_200309;
									break;
								case '13':
							...
							if($confirmed > 0){
								layer.bindTooltip('<h6>' + layer.feature.properties.name_zh + '</h6><div class="confirmed">確診 ' + $confirmed + ' 例</div><div class="death">死亡 ' + $death + ' 例</div><div class="note">' + layer.feature.properties.note + '</div>');
							}
						})
					},
					setMarker(date){
					...
					style(feature) {
						...
						switch(this.date){
							...
							case '3':
								...
								break;
							case '4':
								$color = feature.properties.confirmed_200126;
								break;
							case '5':
								$color = feature.properties.confirmed_200202;
								break;
							case '6':
								$color = feature.properties.confirmed_200205;
								break;
							case '7':
								$color = feature.properties.confirmed_200210;
								break;
							case '8':
							...
							case '11':
								...
								break;
							case '12':
								$color = feature.properties.confirmed_200309;
								break;
							case '13':
					...
					// 	var ferryIcon = new LeafIcon({iconUrl: 'img/ferry.svg'});

					// 	map = L.map('leaflet').setView([33.798544, 103.844217], 4)
					...
					// 	geojson = L.geoJson(this.handleMap, {
					// 		style: style,
					// 		onEachFeature: onEachFeature
					// 	}).addTo(map)
					// 	geojson.eachLayer(function (layer) {
					// 		var $confirmed = layer.feature.properties.confirmed_200123
					// 		var $death = layer.feature.properties.death_200123
					// 		if($confirmed > 0){
					// 			layer.bindTooltip('<h6>' + layer.feature.properties.name_zh + '</h6><div class="confirmed">確診 ' + $confirmed + ' 例</div><div class="death">死亡 ' + $death + ' 例</div><div class="note">' + layer.feature.properties.note + '</div>');
					// 		}
					// 	});
						
					// 	L.marker([34.548471, 139.653540], {icon: ferryIcon}).addTo(map).bindPopup('<h6>鑽石公主號</h6><div class="confirmed">確診 '+this.dpConfirmed+' 例</div><div class="death">死亡 '+this.dpDeath+' 例</div><div class="note"></div>')
					...
					// 			color: '#5b5b5b',
					// 			fillOpacity: 1,
					// 			fillColor: getColor(feature.properties.confirmed_200123)
					// 		};
					// 	}

					// 	function getColor(num) {
					// 		return num > 2999 ? '#350000' :
					// 			   num > 999  ? '#600000' :
					// 			   num > 499  ? '#910000' :
					// 			   num > 199  ? '#d32f2f' :
					// 			   num > 99   ? '#f95050' :
					...
					// 		this._div.innerHTML = (props ? '<h6>' + props.name_zh + '</h6><div class="confirmed">確診 ' + props.confirmed + ' 例</div><div class="death">死亡 ' + props.death + ' 例</div><div class="note">' + props.note + '</div>' : '');
					// 	};
					// 	info.addTo(map);


					// 	function infoDisplay(boolean){
					// 		var $info = $('.info.leaflet-control'),
					// 			$leaflet = $('.leaflet-overlay-pane');
					
					// 		if(boolean){
					// 			TweenLite.to($info, .2, {alpha: 1, scale: 1});
					// 			if (L.Browser.touch){
					// 				$leaflet.bind('mousedown', (e)=>{
					// 					TweenLite.set($info, {x: e.clientX - 50, y: e.clientY - 175 });
					// 				})
					// 			} else {
					// 				$leaflet.bind('mousemove', (e)=>{
					// 					TweenLite.to($info, .2, {x: e.clientX, y: e.clientY });
					// 				})
					// 			}
								
					// 		} else {
					// 			$leaflet.unbind('mousemove')
					// 			TweenLite.to($info, .2, {alpha: 0, scale: 0});
					// 		}
					// 	}
					// 	infoDisplay(false)
					// },
					...
					filterDisplay(boolean){
						if(boolean){
							TweenLite.to($('.map .filter.mobile'), .5, {x: -250, ease: Power3.easeOut})
							$('.map .button.menu span').fadeOut(300)
						} else {
							TweenLite.to($('.map .filter.mobile'), .5, {x: 250, ease: Power3.easeIn})
						}
					}
				},
				computed: {
					...
					sumConfirmed(){
						let sum = 0
						for(let i in this.dataCSV){
							sum += this.dataCSV[i].confirmed
						}
						return sum
					},
					sumDeath(){
